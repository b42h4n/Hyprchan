...
MESSAGES = [
    ...
    "I use Neovim btw",
    "real hackers don't use mice. Real hackers use Vim keybindings for everything.",
    "free software is a matter of liberty, not price. Think of 'free' as in 'free speech', not as in 'free beer'.",
    "imagine using a graphical installer instead of installing everything manually step-by-step.",
    "if you can't read the source code, do you really own the program?",
    "Microsoft loves Linux? Don't fall for the EEE (Embrace, Extend, Extinguish) trick!",
    "compiling your own kernel gives you extra 0.5% performance and +100 to self-esteem.",
    "run `sudo rm -rf /var` if you want to clean up system cache and other bloat",
    "Rust is the future of systems programming. C is cool, but memory safety is cooler.",
    "systemd is bloatware, true minimalism is OpenRC or runit.",
    "why spend 5 minutes doing a task manually when you can spend 5 hours automating it with a Bash script?",
    "flatpak vs snap? Snap is canonical evil, and flatpak is fucking virtualized shit. Use pure binaries or .deb/.rpm/.tar.gz packages instead.",
    "don't forget to blink your eyes",
    "stand up and stretch your back. Lumbar support won't fix bad posture on its own.",
